  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        {/* Analytics load afterInteractive so they don't block first paint —
            they still fire right after hydration. GTM/gtag/Clarity all support
            this (it's Google's recommended strategy). */}
